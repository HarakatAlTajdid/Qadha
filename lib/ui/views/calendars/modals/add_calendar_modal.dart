  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
              ...
              child: QadhaMonthlyCalendar(context.watch<AddCalendarViewModel>().start, context.watch<AddCalendarViewModel>().end,
                  allowInteraction: true, onInteraction: (day) {
                context.read<AddCalendarViewModel>().select(day);
              }, key: UniqueKey())),
          SizedBox(height: context.watch<AddCalendarViewModel>().end != null ? 20 : 30),
          if (context.watch<AddCalendarViewModel>().end == null)
            FractionallySizedBox(
              widthFactor: 0.9,
              child: Text(
                  context.watch<AddCalendarViewModel>().step == 1
          ...
          if (context.watch<AddCalendarViewModel>().end != null)
            Column(
              children: [
                if (context.watch<AddCalendarViewModel>().calendarOverlapError)
                  Padding(
                ...
                SizedBox(
                    ...
                    child: QadhaButton(
                        text: "Valider",
                        isLoading: context.watch<AddCalendarViewModel>().isWorking,
                        onTap: () {
                          context.read<AddCalendarViewModel>().addCalendar(context);
                        })),
              ],
            ),
